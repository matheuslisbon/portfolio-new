...
export default function About() {
  ...
  return (
    <main className="w-full">  
      ...
      <AnimatePresence>
        <div  className="md:grid md:grid-cols-2 justify-between items-center md:gap-32 gap-2 flex flex-col-reverse ">
