...
export default function About() {
  ...
  return (
    <main className="w-full">  
      ...
      <AnimatePresence>
        <div  className="grid grid-cols-2 justify-between items-center md:gap-32 ">
